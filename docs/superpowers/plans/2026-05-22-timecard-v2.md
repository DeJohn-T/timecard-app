...
@keyframes pay-glow {
  0%, 100% { box-shadow: 0 0 14px 2px rgba(212, 168, 75, 0.3); }
  50%       { box-shadow: 0 0 28px 8px rgba(212, 168, 75, 0.55); }
}
@keyframes today-pulse {
  0%, 100% { box-shadow: 0 0 0 0 rgba(200, 121, 65, 0.4); }
...
.payday-card  { animation: pay-pulse 1.8s ease-in-out infinite; }
.payday-today { animation: pay-glow 1.4s ease-in-out infinite; }
.today-btn    { animation: today-pulse 2.4s ease-in-out infinite; }
...
Open `http://localhost:5174` in a browser. Confirm: dark brown background, amber accents on buttons and selected day, Cormorant Garamond loading in the title. No blue anywhere.
